...
int main(int argc, char* argv[])
{
    ...
    
    {
        ...
        // Generate logs from all nodes if the input file demands it, otherwise only log node 0.
        ...
        // Get the interval of timesteps in which visual plots will be written to disk.
        int viz_dump_interval = 0;
        if (main_db->keyExists("viz_dump_interval")) {
            viz_dump_interval = main_db->getInteger("viz_dump_interval");
        }
        
        // Set the output directory in which visualization data output will be written to.
        ...
        // Set interval of timesteps in which restart (or checkpoint) data is output.
        ...
        // Only write restart data if interval is set from input file and if the restart directory is initially empty.
        ...
        // If we want to restart, open the restart file for reading from the specified timestep.
        if (is_from_restart) {
            restart_manager->
        ...
        // Create timer manager object and read and set options for the timer manager from the input file.
        ...
        // Create an object specific to the enlightning simulation and read and store data from "enlightning" section of the input file.
        ...
        tbox::plog << "Check input data and variables before simulation:" << endl << endl;
        ...
        // Set the iteration number, and save the iteration number the current run started at.
        ...
        while ((loop_time < enlightning_model->getEndTime()) &&
            ...
            if (enlightning_model->shouldRecordAudio())
                enlightning_model->recordAudio(patch_hierarchy);
            ...
            for (int i = 0; i < (TIME_WINDOW_SIZE-1); i++)
                time_window[i] = time_window[i+1];
